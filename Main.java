...
public class Main {
    ...
    public static void addItemsToShop(Scanner sc, Shop shopTable, String message){
        System.out.println(message);
    ...
    public static void deleteItemsFromShop(Scanner sc, Shop shopTable, String message){
        System.out.println(message);
        shopTable.printShopItems();
        String userInput = sc.next();
        if(shopTable.search(userInput) != -1) {
